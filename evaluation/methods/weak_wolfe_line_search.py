# Weak Wolfe line search (sufficient decrease + weak curvature condition).
# Adapted from pytorch-minimize's strong Wolfe for use with Powell damping
# in stochastic and non-convex settings.
