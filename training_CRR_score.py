...
train_dataloader = torch.utils.data.DataLoader(
    train_set, batch_size=32, shuffle=True, drop_last=True, num_workers=0
)
val_dataloader = torch.utils.data.DataLoader(
    val_set, batch_size=1, shuffle=False, drop_last=True, num_workers=0
)

# define regularizer
# not sure this has to reflect the score noise here?
noise_level = 0.1
...
torch.save(regularizer.state_dict(), f"weights/CRR_score.pt")
